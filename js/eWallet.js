...
const createNewTransaction = () => {
  ...
  if (selectedCategory.includes(plus)) {
    incomeSection.appendChild(newTransaction) &&
      newTransaction.classList.add("income");
  } else if (selectedCategory.includes(minus)) {
    expensesSection.appendChild(newTransaction) &&
      newTransaction.classList.add("expense");
    amountInput.value = character + amountInput.value;
  }
...
const deleteAllTransaction = () => {
  incomeSection.innerHTML = "<h3>Incomes:</h3>";
  expensesSection.innerHTML = "<h3>Expanses:</h3>";
...
lightStyleBtn.addEventListener("click", changeStyleLight);
